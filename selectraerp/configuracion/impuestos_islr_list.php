...
<?
	titulo($modulo,"impuestos_islr_add.php","../menu_int.php?cod=10","18");
?>
...
<?
	...
	$codigo=$fila["cod_impuesto_isrl"];
	icono("impuestos_islr_edit.php?codigo=".$codigo."&pagina=".$pagina, "Editar", "edit.gif");
	icono("impuestos_islr_delete.php?codigo=".$codigo."&pagina=".$pagina, "Eliminar", "delete.gif");
