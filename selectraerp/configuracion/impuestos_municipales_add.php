...
$url="impuestos_municipales_list";
$modulo="Impuestos Municipales";
$tabla="impuestos_municipales";
$titulos=array("Descripción","Factor","Monto Mínimo","Factor Bomberos");
...
<TBODY>
<?$consulta="select max(cod_impuesto_municipal) as valor from impuestos_municipales";
$resultado_municipales=query($consulta,$conexion);
//echo $consulta;
$fila_municipales=fetch_array($resultado_municipales);
$max_municipales=$fila_municipales['valor'];
$valor=$max_municipales+1;
?>
<tr>
      <td colspan="2" height="30" class="tb-tit"><strong>Agregar Nuevo Registro de <?echo $modulo?></strong></td>
    </tr>
	<td class="tb-head" width="180">C&oacute;digo Impuesto Municipal</td>
      	<td colspan="6"><?echo $valor;?> <INPUT type="hidden" name="cod_impuesto_municipal" value="<?=$valor?>"></td>
