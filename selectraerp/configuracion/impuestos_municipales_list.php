...
$titulos=array("Código","Descripción","Factor","Monto Mínimo","Factor Bomberos");
...
<?
	titulo($modulo,"impuestos_municipales_add.php","../menu_int.php?cod=10","20");
?>
...
<?
	...
	$codigo=$fila["cod_impuesto_municipal"];
	icono("impuestos_municipales_edit.php?codigo=".$codigo, "Editar", "edit.gif");
	icono("impuestos_municipales_delete.php?codigo=".$codigo, "Eliminar", "delete.gif");
