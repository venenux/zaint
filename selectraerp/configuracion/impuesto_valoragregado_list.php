...
$titulos=array("Código","% I.V.A.","% Retención");
$indices=array("0","2","3");
...
<?
	titulo($modulo,"impuesto_valoragregado_add.php","../menu_int.php?cod=10","19");
?>
...
<?
	...
	$codigo=$fila["codigo"];
	icono("impuesto_valoragregado_edit.php?codigo=".$codigo, "Editar", "edit.gif");
	icono("impuesto_valoragregado_delete.php?codigo=".$codigo, "Eliminar", "delete.gif");
