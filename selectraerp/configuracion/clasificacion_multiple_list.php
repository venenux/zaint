...
<?
	titulo($modulo,"clasificacion_multiple_add.php","../menu_int.php?cod=10","16");
?>
...
<?
	...
	$codigo=$fila["codigo"];
	icono("clasificacion_multiple_edit.php?codigo=".$codigo, "Editar", "edit.gif");
	icono("clasificacion_multiple_delete.php?codigo=".$codigo, "Eliminar", "delete.gif");
