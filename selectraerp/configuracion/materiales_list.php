...
if(isset($_POST['buscar']) || $tipob!=NULL){
	...
	$consulta="select * from ".$tabla." order by cod_material_snc";
}
...
<?
	titulo($modulo,"","../menu_int.php?cod=2","13");
?>
  ...
  <tr>
	<td><input type="text" name="buscar" size="20"></td>
       ...
       <option value="descripcion">Descripci&oacute;n</option>
		 <option value="cod_material_snc">C&oacute;digo</option>
     </SELECT></TD>
...
<?
	...
	$codigo=$fila["cod_material_snc"];
	icono("materiales.php?codigo_snc=".$codigo."&paginam=".$pagina, "Materiales de la Categoria", "view.gif");
