...
<TBODY>
<?$consulta="select max(codigo) as valor from impuesto_valoragregado";
...
<tr>
	...
	<td class="tb-head" width="200">C&oacute;digo Impuesto Valor Agregado</td>
