...
<TBODY>
<? $consulta="select max(cod_estado) as valor from estados";
$resultado_estado=query($consulta,$conexion);
//echo $consulta;
$fila_estado=fetch_array($resultado_estado);
$max_estado=$fila_estado['valor'];
$valor=$max_estado+1;
...
<tr>
	...
	<td class="tb-head">C&oacute;digo Estado</td>
      	<td colspan="6"><?echo "$valor";?> <INPUT type="hidden" name="cod_estado" value="<?echo "$valor";?>"></td>
