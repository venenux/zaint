...
$tabla="aporte_social";
$titulos=array("Código","Descripción","% Aporte");
$indices=array("0","1","2");
...
<?
	titulo($modulo,"aporte_social_add.php","../menu_int.php?cod=10","125");
?>
...
<?
	...
	$codigo=$fila["codigo"];
	icono("aporte_social_edit.php?codigo=".$codigo, "Editar", "edit.gif");
	icono("aporte_social_delete.php?codigo=".$codigo, "Eliminar", "delete.gif");
