...
$consulta="select * from ".$tabla." order by cod_unidad";
}
...
<?
	titulo($modulo,"unidades_add.php","../modulos/principal/?opt_menu=1","12");
?>
...
<?
	...
	//echo $descripcion;
	icono("unidades_edit.php?codigo=".$codigo, "Editar", "edit.gif");
	icono("unidades_delete.php?codigo=".$codigo, "Eliminar", "delete.gif");
	icono("centros_list.php?codigo=".$codigo, "Centros", "12.png");
