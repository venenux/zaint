...
$tabla="parametros";
$titulos=array("Nombre de la Empresa","R.I.F.");
$indices=array("1","14");
...
if(isset($_POST['buscar']) || $tipob!=NULL){
	...
	switch($tipob){
		case "exacta": 
			$consulta=buscar_exacta($tabla,$des,"nomemp");
			break;
		case "todas":
			$consulta=buscar_todas($tabla,$des,"nomemp");
			break;
		case "cualquiera":
			$consulta=buscar_cualquiera($tabla,$des,"nomemp");
			break;
	}
}else{
...
<?
	...
	{
		$agregar="parametros_add.php";
	}
	titulo($modulo,$agregar,"../menu_int.php?cod=10","11");
?>
...
<?
	...
	$codigo=$fila["codigo"];
	icono("parametros_edit.php?codigo=".$codigo, "Editar", "edit.gif");
