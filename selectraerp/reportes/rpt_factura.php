...
SELECT f . * , c.nombre, c.direccion, c.nit, c.cod_cliente, c.rif, c.telefonos, c.direccion, v.nombre AS nom_vendedor, fd . * , fp . * , i.cod_item, ifor.descripcion AS tipo_item_
FROM factura f
