...
class PDF extends FPDF {
	...
	$this->Image('../libs/imagenes/asys.jpg', 6 ,10, 45, 28,'JPG', '');
        $this->Cell(150,0,'DETALLE DE PAGOS DE MAS',0,0,'C');
	$this->Ln(6);
    ...
    function ChapterBody() {
		...
		$this->Row(array('Finiquito','Aseguradora','Factura','Monto','Convertura Imp.', 'Deducible', 'Pago', 'Diferencia'),1);
...
$pdf=new PDF('L','mm','A4');
$title='Lista de CLientes por Autorizar.';
