...
class PDF extends FPDF {
	...
	function Header() {
		...
		$array_parametros_generales = $comunes->ObtenerFilasBySqlSelect("select * from clientes where id_cliente =".$cliente);
		...
		$this->Ln(6);
		$this->SetX(55);
		$this->Cell(92,0,'Cliente: '.utf8_decode($array_parametros_generales[0]['nombre']),0,0,'L');
		$this->Ln(6);
		$this->SetX(55);
...
$array_factura = $comunes->ObtenerFilasBySqlSelect("SELECT * from cxc_edocuenta");
$pdf=new PDF('L','mm','A4');
