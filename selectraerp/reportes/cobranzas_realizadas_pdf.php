...
class PDF extends FPDF {
	...
	$this->Image('../imagenes/SiSalud.jpg', 6 ,10, 45, 28,'JPG', '');
        ...
        $this->Cell(169,0,'DETALLE DE COBRANZAS REALIZADAS',0,0,'C');
	$this->Ln(6);
    ...
    function ChapterBody() {
        ...
        $this->SetWidths(array(30,15,25,25,25,25,25,25,25,25));
		...
		$this->Row(array('Factura','Serie','F. Pago','Finiquito','Monto', 'Cobro', 'Pagado Con', 'Del Banco','Procesado','Por'),1);
