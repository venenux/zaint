...
if(isset($_POST['guardar'])){
	...
	location.href=\"".$url.".php?pagina=".$pagina."&codigo=".$val."&cod_centro=".$val2."&paginam=".$paginam."\"
	</SCRIPT>";
...
<?
	titulo("Agregar nuevo registro de ".$modulo,"","requisiciones3.php?codigo=".$cod_unidad."&cod_centro=".$cod_centro."&pagina=".$pagina,"12");
?>
...
<?
	...
	{
		?>
		<td width="100"><? echo $fila_det['cod_item'];?></td>
