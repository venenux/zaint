...
function pass_value(thevalue,theid,indice,unidad){
...
columna1.innerHTML="<input name=\"cod_material[]\"  id=\"cod_material[]\" type=\"text\" readonly=\"true\" style=\"width:100%\" size=\"10\" value=\""+theid+"\">"
...
columna3.innerHTML="<input name=\"cantidad[]\" onblur=\"javascript:verificar_existencia('"+theid+"','cantidad"+contador2+"');\" type=\"text\" id=\"cantidad"+contador2+"\" style=\"width:100%\" size=\"10\" /> <input name=\"medida[]\" type=\"hidden\" id=\"medida\" value='"+unidad+"'>"
...
//opener.document.formadd.descripcion.value = thevalue;
//opener.document.formadd.cod_material.value = theid;
//parent.close();
}
</script>
<?php
...
?>
	...
	<!-- Table body -->
	<tr<?php echo $sItemRowClass; ?><?php echo $sListTrJs; ?>  style="cursor : pointer;" onclick="javascript:pass_value('<? echo $descripcionj?>','<?php echo $x_cod_material; ?>','<?=$indice?>','<?php echo $x_unidad; ?>')">
<?$indice++;?>
		<!-- cod_material -->
