...
function fn_cantidad(){
			...
			$(".span_cantidad_items").html("<span style=\"font-size: 10px;\">Cantidad de Items: "+cantidad+"</span>");
                        ...
                        $("input[name='input_cantidad_items']").attr("value",cantidad.toFixed(2));$.totalizarFactura();
	                ...
	                success: function(data){
	                    ...
	                    if(resultado[0].id=="-1"){
							return false;
							 ...
							 if(datoscliente[0].cod_tipo_precio==$("#idprecio1").val()){$("#precioProductoPedido").val(parseFloat(resultado[0].precio1));}//Precio 1
							 if(datoscliente[0].cod_tipo_precio==$("#idprecio2").val()){$("#precioProductoPedido").val(parseFloat(resultado[0].precio2));}//Precio 2
							 if(datoscliente[0].cod_tipo_precio==$("#idprecio3").val()){$("#precioProductoPedido").val(parseFloat(resultado[0].precio3));}//Precio 3
