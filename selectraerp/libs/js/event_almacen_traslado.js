             ...
             buttons:[
                        {
                            ...
                            handler:function(){
                                ...
                                if($("#items").val()==""||$("#almacen_salida").val()==""||$("#almacen_entrada").val()==""||$("#cantidadunitaria").val()==""){
                                ...
                                if(($("#cantidadunitaria").val())>($("#cantidad_existente").val())){
                                         Ext.Msg.alert("Alerta","XLa cantidad a descargar no puede ser mayor a la existente");
                                        return false;
                                }
