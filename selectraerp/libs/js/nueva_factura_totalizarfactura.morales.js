    ...
    $("input[name='totalizar_monto_efectivo']").val($("input[name='totalizar_total_general']").val());
        ...
        $(".tab").live("mouseover", function(){
           ...
           tabclick = $(this).attr("id");
            ...
            if(tabclick=="tab2"){$(".tabpanel1").hide();$(".tabpanel2").show();$("#totalizar_monto_cancelar").trigger("click")}
...
//alert(parseFloat($(this).val()))
        ...
        if(parseFloat($(this).val())/*$("input[name='totalizar_monto_cancelar']")*/>parseFloat(resultado)){
        	//************************************************************************************
        	...
        	/*$("input[name='totalizar_cambio']").select();*/
        	//$("input[name='totalizar_cambio']").val(cambio.toFixed(2));
        	//$("input[name='totalizar_saldo_pendiente'], input[name='totalizar_cambio']").val("0");///// borrar
        	//************************************************************************************
        	}
...
//#INSTRUMENTO DE PAGO
    ...
    if(!confirm("¿Esta seguro de generar?")){
        return false;
    }
});
