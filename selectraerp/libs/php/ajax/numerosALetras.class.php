...
*/
		...
		*/
		function numerosALetras($valor=''){
                    ...
                    $this->data_moneda = $conn->ObtenerFilasBySqlSelect("select moneda_base, Nombre from divisas,parametros_generales where id_divisa= moneda_base");
                    $this->antes_con_despues = $this->data_moneda[0]["Nombre"]." con";
                    $this->antes_sin_despues = $this->data_moneda[0]["Nombre"]." con 00/100";
