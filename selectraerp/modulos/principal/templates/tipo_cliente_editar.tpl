...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_tipo_cliente" value="{$datos_tipo_cliente[0].cod_tipo_cliente}" id="cod_tipo_impuesto" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion" value="{$datos_tipo_cliente[0].descripcion}" size="60" id="descripcion" >
    </td>
</tr>
</table>
