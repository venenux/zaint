...
<tr>
    ...
    <td >
        <input type="text" name="cod_impuesto" value="#Numero" id="cod_impuesto" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
...
{html_options output=$option_output_funcionformula values=$option_values_funcionformula}
</select>
...
<tr>
    ...
    <td >
        <input type="text" name="siglas" size="60" id="siglas" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="codificacion_impuesto" size="60" id="codificacion_impuesto" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td>
        <input type="text" name="alicuota" size="60" id="alicuota" >
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="text" name="pago_mayor_a" size="60" id="pago_mayor_a">
    </td>
</tr>
...
<tr>
    ...
    <td >
        <input type="text" name="monto_sustraccion" size="60" id="monto_sustraccion" >
    </td>
</tr>
