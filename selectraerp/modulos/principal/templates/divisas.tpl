        ...
        <tr class="row-br">
            <td>
                <table class="tb-tit" cellspacing="0" cellpadding="1" border="0" width="100%">
                    <tbody>
                        <tr>
                        <td width="900"><span style="float:left">  <img src="../../libs/imagenes/moneda.png"  width="22" height="22" class="icon" />{$campo_seccion[0].nom_menu}</span></td>
                        <td width="75">
                            <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=add&agregarMoneda={$agregarMoneda}'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                        ...
                        <td width="75">
                            <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu={$smarty.get.opt_menu}&opt_seccion=103'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 0px;" align="right"><img src="../../libs/imagenes/bt_left.gif" alt="" width="4" height="21" style="border-width: 0px;" /></td>
...
{else}
    ...
    {else}
        <tr  bgcolor="#e1e1e1">
    {/if}
        <td >{$campos.id_divisa}</td>
        <td>{$campos.Nombre}</td>
        <td>
            <img  style="cursor: pointer;" class="editar"  onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=edit&cod={$campos.id_divisa}'" title="Editar" src="../../libs/imagenes/edit.gif">
