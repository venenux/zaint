...
<form name="formulario" id="formulario" method="post">
    ...
    <div style="clear:left;" class="contenedor_factura">
        ...
        <div id="detalle_factura_">
            ...
            <div class="resumen">
                Sub-Total
                <div style="font-size:20px; color:#2e931a;" id="subTotal">0.00 Bs.</div>
            ...
            <div class="resumen">
                ...
                <div style="font-size:20px; color:red; text-decoration:line-through;" id="descuentosItemFactura">0.00 Bs.</div>
            </div>
            <div class="resumen">
                Monto Items
                <input type="hidden" name="input_montoItemsFactura" id="input_montoItemsFactura" value=""/>
                <div style="font-size:20px; color:#2e931a;" id="montoItemsFactura">0.00 Bs.</div>
            </div>
            <div class="resumen">
                I.V.A
                <input type="hidden" name="input_ivaTotalFactura" id="input_ivaTotalFactura" value=""/>
                <div style="font-size:20px; color:#2e931a;" id="ivaTotalFactura">0.00 Bs.</div>
            </div>
            <div class="resumen">
                Total
                <input type="hidden" name="input_TotalTotalFactura" id="input_TotalTotalFactura" value=""/>
                <div style="font-size:20px; color:#00005e;" id="TotalTotalFactura">0.00 Bs.</div>
            </div>
            <br/><br/><br/>
                                ...
                                <td style="vertical-align:top;">
                                    ...
                                    <div>
                                        <table style="border: 1px solid #949494;">
                                            <tr>
                                                <td style="background-color:white; vertical-align: top;">
                                                    <table id="tabla_total" style="background-gcolor: white;">
                                                        <thead>
                                                            <tr>
                    ...
                    <table style="width:100%;" class="lista">
                        ...
                        <tfoot>
                            <tr class="sf_admin_row_1">
                                <td colspan="10">
                                    <div class="span_cantidad_items"><span style="font-size: 12px; font-style: italic;">Cantidad de Items: 0</span></div>
                                </td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div id="contenedorTAB21">
                ...
                <div class="tabpanel2">
                    <table>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="vertical-align:top; width:50%;">
                                Saldo Pendiente
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Cheque</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Monto Cheque</td>
                            <td>
                                <input type="text" class="ctotalizar_" value="0" name="totalizar_monto_cheque" id="totalizar_monto_cheque"/> (*)
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Nro. Cheque</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Tarjeta</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Deposito</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Monto del Dep&oacute;sito</td>
                            <td>
                                <input type="text" value="0" class="ctotalizar_" name="totalizar_monto_deposito" id="totalizar_monto_deposito"/>   (*)
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Nro. de Dep&oacute;sito</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Otro Documento</td>
                            <td>
                        ...
                        <tr>
                            <td colspan="3" class="tb-head" style="width:50%;">Tipo de Documento</td>
                            <td>
