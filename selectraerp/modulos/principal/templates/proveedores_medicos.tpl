...
{else}
	...
	<!-- <img style="cursor: pointer;" class="imprimir" onclick="javascript: window.location.href='../../reportes/rpt_detalle_pago_medicos.php?id_proveedor={$campos.id_proveedor}';" title="Imprimir Relacion de Convenio"  src="../../libs/imagenes/ico_print.gif"> -->
...
<img  style="cursor: pointer;" class="eliminar" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=imprimirFacturas&id_proveedor={$campos.id_proveedor}'" title="Imprimir Relacion de Facturas/Servicios"  src="../../libs/imagenes/ico_list.gif">
	...
	<img style="cursor: pointer;" class="imprimir" onclick="javascript: window.location.href='../../reportes/rpt_cxp_estado_cuenta_medicos.php?id_proveedor={$campos.id_proveedor}';" title="Imprimir Relacion de Convenio"  src="../../libs/imagenes/ico_print.gif">
        </td>
    </tr>
