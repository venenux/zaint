    ...
    $(document).ready(function(){
        ...
        $("#formulario").submit(function(){
                if($("#descripcion_linea").val()==""){
                    alert("Debe Ingresar la descripción de la Linea!.");
                    $("#descripcion_linea").focus();
                    return false;
                }
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_linea" value="{$campo_linea[0].cod_linea}" id="cod_linea" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion_linea" value="{$campo_linea[0].descripcion}" size="60" id="descripcion_linea" >
    </td>
</tr>
</table>
