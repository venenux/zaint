...
<tr>
    ...
    <td >
        <input type="text" name="cod_formula" value="{$datos_formula[0].cod_formula}" id="cod_formula" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
...
{html_options output=$option_output_funcionentidad values=$option_values_funcionentidad selected=$option_selected_entidad}
</select>
...
{html_options output=$option_output_funciontipoimpuesto values=$option_values_funciontipoimpuesto selected=$datos_formula[0].cod_tipo_impuesto}
...
<tr>
    ...
    <td >
<input type="text" name="fecha_aplicacion"  value="{$datos_formula[0].fecha_aplicacion}" id="fecha_aplicacion" size="15" maxlength="12">&nbsp;Ej.: 0000-00-00
...
<tr>
    ...
    <td >
        <input type="text" name="descripcion" size="60"  value="{$datos_formula[0].descripcion}" id="descripcion" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <textarea cols="58" rows="10" id="formula" name="formula">{$datos_formula[0].formula}</textarea>
    </td>
</tr>
