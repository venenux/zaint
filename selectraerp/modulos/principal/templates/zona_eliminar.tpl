...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_zona" value="{$datos_zona[0].cod_zona}" id="cod_zona" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion_zona" readonly value="{$datos_zona[0].descripcion}" size="60" id="descripcion_zona" >
    </td>
</tr>
</table>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="eliminar" id="aceptar" value="Eliminar Almacen">
    </td>
    </tr>
    </tbody>
</table>
