...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_formapago" value="{$datos[0].cod_formapago}" id="cod_formapago" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" disabled readonly name="descripcion" value="{$datos[0].descripcion}" size="60" id="descripcion" >
    </td>
</tr>
<tr>
    <td valign="top"   colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <select disabled name="cod_funcioninstrumento" id="cod_funcioninstrumento">
{html_options output=$option_output_funcioninstrumentopago values=$option_values_funcioninstrumentopago selected=$option_selected_funcioninstrumentopago}
</select>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="aceptar" id="aceptar" value="Eliminar Instrumento de pago">
    </td>
    </tr>
    </tbody>
</table>
