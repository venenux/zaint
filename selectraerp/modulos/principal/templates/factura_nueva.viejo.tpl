...
<!-- script type="text/javascript" src="../../libs/js/buscar_item.js"></script-->
...
<form name="formulario" id="formulario" method="post">
                ...
                <tr>
                    <td> 
                        ...
                        <div style="float: left; margin: 0 10px 10px 0;" >
                            ...
                            <select name="cod_vendedor" id="cod_vendedor" accesskey="v" tabindex="10">
                    ...
                    <td>
                        <div style="float: right; margin: 0 0 10px 10px;" id="pedidos">
                            ...
                            <img align="absmiddle" src="../../libs/imagenes/11.png" title="Facturar Pedido">
    ...
    <div id="lista_pedidos" style="background-color:#ffffff; border: 1px solid #ededed;-moz-border-radius: 7px;padding:5px; margin-top:0.3%;margin-right: 0.3%;   font-size: 13px; ">
        <table width="100%">
            <thead>
                <tr>                
                    <th class="tb-tit">Cod. Pedido</th>
                    <th class="tb-tit">Fecha de Emision</th>
                    <th class="tb-tit">Monto (Bs) Pedido</th>
                    <th class="tb-tit"></th>
                </tr>
            </thead>
            <tbody>
                {foreach from=$pedidos key=a item=pedido}
                    <tr>
                        <td align="left">{$pedido.cod_pedido}</td>
                        <td align="left">{$pedido.fechaPedido}</td>
                        <td align="left">{$pedido.totalizar_total_general}</td>
                        <td>
                            <div id="seleccionarPedido">
                                <input type="hidden" id="hijo" name="hijo" value="{$pedido.id_pedido}">
                                <!--input type="hidden" id="cod_prod" name="cod_prod" value="{$pedido.cod_item}"-->
                                <img title="Seleccionar Pedido {$pedido.cod_pedido}" src="../../libs/imagenes/add.gif">
                            </div>
                        </td>
                    </tr>
                {/foreach}
                ...
                <td colspan="2" >
                    <table style="cursor: pointer;" class="MostrarTabla" id="MostrarTabla" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="btn_bg" nowrap style="padding: 0px 1px;width:120px"><div id="LabelMensaje" accesskey="a">Agregar Nuevo Item</div></td>
                            <td style="padding: 0px;" align="left"><img  src="../../libs/imagenes/bt_right.gif" alt="" width="4" height="21" style="border-width: 0px;" /></td>
                        </tr>
                    </table>
                </td>
                                        ...
                                        <table width="100%" >
                                            <tr style="border:1px solid #f3f3f3;">
                                               <td colspan="2" style="padding:10px;background-color:white;" valign="top">
                                                     <a href="#" style="color: blue;text-decoration: underline;" id="seleccionItem" accesskey="b"><b>
                                                ...
                                                <td colspan="2">
                                                    <table width="100%" >
                                                        <tr style="border:1px solid #f3f3f3;">
                                                            ...
                                                            <td style="background-color:white;" valign="top">
                                                                <select cod="cod_almacen" id="cod_almacen" tabindex="0">
                                                                </select>
                                                            </td>
                                                            <td valign="top" width="100px" style="background-color:#5084a9; color:white;padding-left:20px;padding-top:5px">
                                                            ...
                                                            <td style="background-color:white;" valign="top">
                                                                <select name="cod_tipo_precio" id="cod_tipo_precio" tabindex="1">
                                                        ...
                                                        <tr style="border:1px solid #f3f3f3;">
                                                            ...
                                                            <td style="background-color:white;" valign="top">
                                                                <input type="text"  size="10"  name="cantidadPedido" value="0" id="cantidadPedido" tabindex="2">	
                                                            </td>
                                                            <td valign="top" width="100px" style="background-color:#5084a9; color:white;padding-left:20px;padding-top:5px">
                                                                <span style="font-family:'Verdana';"><b>Precio sin Iva</b></span>
                                                            </td>
                                                            <td style="background-color:white;" valign="top">
                                                                <input type="text"  size="10"  name="precioProductoPedido" value="0" readonly="readonly" id="precioProductoPedido" tabindex="3">	
                                                            </td>
                                                        </tr>
                                                        <tr style="border:1px solid #f3f3f3;">
                                                            <td valign="top" width="100px" style="background-color:#5084a9; color:white;padding-left:20px;padding-top:5px">
                                                            ...
                                                            <td style="background-color:white;" valign="top">
                                                                <input type="text" name="descuentoPedido" value="0" title="Descuento maximo del cliente: {$datacliente[0].porc_parcial} %" size="10"  id="descuentoPedido" tabindex="4">	 %
                                                            </td>
                                                            <td valign="top" width="100px" style="background-color:#5084a9; color:white;padding-left:20px;padding-top:5px">
                                                                <span style="font-family:'Verdana';"><b>Monto Descto.</b></span>
                                                            </td>
                                                            <td style="background-color:white;" valign="top">
                                                                <input type="text" name="montodescuentoPedido"  value="0" size="10" readonly="readonly" id="montodescuentoPedido" tabindex="5">	
                                                            </td>
                                                        </tr>
                                                        <tr style="border:1px solid #f3f3f3;">
                                                            <td style="background-color:white;" valign="top">
                                                            ...
                                                            <td colspan="2" style="background-color:white;" valign="top">
                                                                <input type="text" value="0" size="10" name="totalPedido" readonly="readonly" id="totalPedido" tabindex="6">	
                                                            </td>
                                                        </tr>
                                                        <tr style="border:1px solid #f3f3f3;">
                                                            <td style="background-color:white;" valign="top">
                                                                            ...
                                                                            <td width="75">
                                                                                <table style="cursor: pointer;" class="btn_bg" id="addTabla" border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="btn_bg" nowrap style="padding: 0px 1px;" tabindex="7">Incluir</td>
                                                                                        <td style="padding: 0px;" align="left"><img  src="../../libs/imagenes/bt_right.gif" alt="" width="4" height="21" style="border-width: 0px;" /></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                            <td width="75">
                                                                                <table style="cursor: pointer;" class="btn_bg" id="cancelaradd" border="0" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="btn_bg" nowrap style="padding: 0px 1px;" tabindex="8">Cancelar</td>
                                                                                        <td  style="padding: 0px;" align="left"><img  src="../../libs/imagenes/bt_right.gif" alt="" width="4" height="21" style="border-width: 0px;" /></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
