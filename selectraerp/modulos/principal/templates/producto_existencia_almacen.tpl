            ...
            <td>
                <table class="tb-tit" cellspacing="0" cellpadding="1" border="0" width="100%">
                    <tbody>
                       ...
                       <!--
                        <td width="75">
                            <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu={$smarty.get.opt_menu}&opt_seccion=55&opt_subseccion=add'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                                <tr>
...
{else}
    ...
    {/if}
        ...
        <td>
            <img  style="cursor: pointer;" class="ver_productos"  onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=viewProductos&cod={$campos.cod_almacen}'" title="Ver Productos" src="../../libs/imagenes/ir_a.gif">
        </td>
    </tr>
