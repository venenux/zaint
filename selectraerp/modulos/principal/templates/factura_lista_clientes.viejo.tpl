                        ...
                        <tr>
                            <td width="900">
                                <span style="float:left">
                                    <img src="{$campo_seccion[0].img_ruta}" width="22" height="22" class="icon" />{$campo_seccion[0].nom_menu}
                                </span>
                            </td>
                            <td width="75">
    ...
    <table class="seleccionLista" width="100%" cellspacing="0" border="0" cellpadding="1" align="center">
        <tbody>
            ...
            {if ($campos.estado eq "A") }
                <img style="cursor: pointer;" class="newfactura" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=newfactura&cod={$campos.id_cliente}'" title="Nueva Factura"  src="../../libs/imagenes/factu.png">
            {/if}
