        ...
        {else}
            {foreach from = $registros key = i item = campos}
                {if $i%2==0}
                    ...
                    <tr  bgcolor="#e1e1e1">
                    {/if}
                    <td >{$campos.cod_departamento}</td>
                    <td>{$campos.descripcion}</td>
                    <td>
                        <img  style="cursor: pointer;" class="editar"  onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=edit&cod={$campos.cod_departamento}'" title="Editar" src="../../libs/imagenes/edit.gif">
                        <img  style="cursor: pointer;" class="eliminar" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=delete&cod={$campos.cod_departamento}'" title="Eliminar"  src="../../libs/imagenes/delete.gif">
