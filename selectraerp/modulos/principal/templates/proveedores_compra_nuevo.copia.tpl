...
<html>
    ...
    <body>
                                ...
                                <table style="width: 100%" class="lista">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="tb-tit">Opci&oacute;n</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
                    ...
                    <div id="contenedorTAB21">
                        ...
                        <div class="tabpanel2">
                            <table>
                                ...
                                <tr>
                                    <td colspan="3" style="width:50%;" class="tb-head">
        ...
        <div id="incluirproducto" class="x-hide-display">
            <p><b>Producto</b></p>
            <p>
                <input type="text" style="background-color: #c1c0c1; width:100%;" readonly name="items" id="items">
