...
<tr>
    ...
    <td >
        <input type="text" disabled="true" name="ultimo_codigo" value="{$nro_boletoOLD}" id="ultimo_codigo" size="60"  value="{$ultimo_codigo[0].cod_item}">
...
<tr>
    ...
    <td >
        <input type="text" name="cod_item" readonly id="cod_item" size="60" value="{$nro_boletoNEW}">
        <div id="notificacionVCoditem"></div>
    </td>
</tr>
<tr>
