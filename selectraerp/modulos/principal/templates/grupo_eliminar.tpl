...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_grupo" value="{$datos_grupo[0].cod_grupo}" id="cod_grupo" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion_grupo" readonly value="{$datos_grupo[0].descripcion}" size="60" id="descripcion_grupo" >
    </td>
</tr>
</table>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="aceptar" id="aceptar" value="Eliminar Departamento">
    </td>
    </tr>
    </tbody>
</table>
