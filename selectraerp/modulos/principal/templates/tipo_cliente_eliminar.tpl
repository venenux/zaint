...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_tipo_cliente" value="{$datos_tipo_cliente[0].cod_tipo_cliente}" id="cod_tipo_cliente" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion" readonly value="{$datos_tipo_cliente[0].descripcion}" size="60" id="descripcion">
    </td>
</tr>
</table>
...
<table width="100%" border="0">
    ...
    <td>
        <input type="submit" name="eliminar" id="aceptar" value="Eliminar Tipo De Cliente">
    </td>
    </tr>
    </tbody>
</table>
