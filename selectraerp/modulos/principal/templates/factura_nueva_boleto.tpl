<script src="../../libs/js/nueva_facturaboletos_totalizarfactura.js" type="text/javascript"></script>
<link href="../../libs/css/nueva_factura.css" media="screen" rel="stylesheet" type="text/css" />
<script src="../../libs/js/nueva_facturaboletos_scripts.js" type="text/javascript"></script>
...
Factura Boleto Numero
<div style="font-size:15px;color:red;" id="numFactura">{$nro_factura}</div>
</div>
...
<td >
    <input type="text" readonly name="totalizar_base_retencion" value="0" id="totalizar_base_retencion">
</td>
</tr>
<tr>
<td  colspan="3" width="50%" class="tb-head" >
...
<td >
    <input type="text" readonly name="totalizar_pbase_retencion" value="0" id="totalizar_pbase_retencion"> %
</td>
</tr>
<tr>
<td  colspan="3" width="50%" class="tb-head" >
...
<td >
    <input type="text" readonly name="totalizar_monto_retencion" value="0" id="totalizar_monto_retencion">
</td>
</tr>
<tr>
<td  colspan="3" width="50%" class="tb-head" >
...
<td >
     <select name="totalizar_descripcion_base_retencion" id="totalizar_descripcion_base_retencion">
         {html_options values=$option_values_islr output=$option_output_islr}
     </select>
</td>
</tr>
-->
