...
<img  style="cursor: pointer;" class="verCuentas" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=CuentaByBancoConciliacion&cod={$campos.cod_banco}'" title="Ver Cuentas Asociadas"  src="../../libs/imagenes/ico_view.gif">
        </td>
    </tr>
