...
{else}
    ...
    {/if}
        ...
        <td>
            <img style="cursor: pointer;" class="edocuenta" onclick="javascript: window.location.href='?opt_menu={$smarty.get.opt_menu}&opt_seccion={$smarty.get.opt_seccion}&opt_subseccion=autorizarFactura&cod={$campos.id_cliente}'" title="Facturas Enviadas"  src="../../libs/imagenes/edocuenta.png">
        </td>
    </tr>
