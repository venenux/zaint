...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_impuesto_iva" value="{$datos[0].cod_impuesto_iva}" id="cod_impuesto_iva" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" readonly name="descripcion" value="{$datos[0].descripcion}" size="60" id="descripcion" >
    </td>
</tr>
...
<tr>
    ...
    <td >
        <input type="text" readonly name="iva" size="60" id="iva"  value="{$datos[0].iva}">
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" readonly  name="porcentaje" size="60"  value="{$datos[0].porcentaje}" id="porcentaje" >
    </td>
</tr>
</table>
