...
<tr>
    ...
    <td >
        <input type="text" name="cod_formapago" value="#Numero" id="cod_formapago" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
...
{html_options output=$option_output_funcioninstrumentopago values=$option_values_funcioninstrumentopago}
</select>  
