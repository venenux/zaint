...
if(isset($_POST['buscar']) || $tipob!=NULL){
	...
	$instruccion = "SELECT * FROM almacen ";
}
...
$smarty->assign("cabecera",array("Código","Descripción"));
...
//**************************************************************************
$smarty->assign("option_values", array("cod_almacen","descripcion"));
$smarty->assign("option_output", array("Cod. Almacen","DescripciÃ³n"));
