...
$comunes = new Comunes();
$tabla = $name_form = "tipo_movimiento_almacen";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("Tipo de Movimiento","Descripción","Operación"));
...
//**************************************************************************
$smarty->assign("option_values", array("id_tipo_movimiento_almacen","descripcion"));
$smarty->assign("option_output", array("Tipo Movimiento Almacen","Descripción"));
