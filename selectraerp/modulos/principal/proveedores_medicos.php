...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM ".$tabla." where id_pclasif=2";
}
...
$smarty->assign("cabecera",array("Cod. Proveedor",$item["id_fiscal"],"Descripción","Telefonos",""));
...
$smarty->assign("option_output", array("Cod. Proveedor","R.I.F.","Descripción"));
