...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "SELECT * FROM $tabla as k inner join tipo_movimiento_almacen as t on k.tipo_movimiento_almacen=t.id_tipo_movimiento_almacen where operacion='+' order by id_transaccion";
}
