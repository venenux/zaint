...
$comunes = new Comunes();
$tabla = "tipo_movimientos_ban";
$name_form = "tipo_movimientos_bancarios";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("Cod. Tipo Movimiento","Tipo Movimiento"));
...
//**************************************************************************
$smarty->assign("option_values", array("cod_tipo_movimientos_ban","descripcion"));
$smarty->assign("option_output", array("Cod. Tipo Movimiento","Tipo Movimiento"));
