...
if($_POST["cantidad"]!=0){
	...
	for($i=0;$i<$_POST["cantidad"];$i++)
	{
		...
		$INSERT="update cxc_edocuenta set marca='E' where cod_edocuenta=$id_factura_pos";
...
$facs = $cxc->ObtenerFilasBySqlSelect("select * from cxc_edocuenta where id_cliente=".$_GET["cod"]." and marca='P'");
$total = $cxc->ObtenerFilasBySqlSelect("select sum(monto) as monto from cxc_edocuenta where id_cliente=".$_GET["cod"]." and marca='P'");
