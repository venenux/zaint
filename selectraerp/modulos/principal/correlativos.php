...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM correlativos";
}
...
$smarty->assign("cabecera",array("Campo","Formato","Consecutivo","-"));
...
//**************************************************************************
$smarty->assign("option_values", array("campo","formato","contador"));
$smarty->assign("option_output", array("Campo","Formato","Contador"));
