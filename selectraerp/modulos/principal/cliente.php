...
$smarty->assign("cabecera", array("C&oacute;d. Cliente", "Nombre y Apellido / Raz&oacute;n Social", "CI / " . $item["id_fiscal"], "Tel&eacute;fonos"));
...
$smarty->assign("option_output", array("CI / " . $item["id_fiscal"], "C&oacute;d. Cliente", "Nombre"));
