...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'seleccionarFecha6.tpl', 25, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
' readonly class="form-text" />
                                <!--input type="text" name="fecha" id="fecha" size="20" value='' class="form-text" readonly /-->
