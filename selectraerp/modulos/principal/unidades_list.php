...
if (isset($_POST['buscar']) || $tipob != NULL) {
    ...
    $instruccion = "select * from " . $tabla . " order by cod_unidad";
}
...
$smarty->assign("cabecera", array("C&oacute;digo", "Descripci&oacute;n"));
...
//**************************************************************************
$smarty->assign("option_values", array("cod_unidad", "descripcion"));
$smarty->assign("option_output", array("C&oacute;digo", "Descripci&oacute;n"));
