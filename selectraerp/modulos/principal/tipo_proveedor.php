...
$comunes = new Comunes();
$tabla = $name_form = "tipo_proveedor_clasif";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
//**************************************************************************
$smarty->assign("option_values", array("id_pclasif","clasificacion"));
$smarty->assign("option_output", array("Cod. del Tipo","Descripcion"));
