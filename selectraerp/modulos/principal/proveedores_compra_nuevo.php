<?php
/*
 * Actualizaciones y mejoras: Charli J. Vivenes Rengel
        ...
        if ($_POST["num_factura"] != "" && $_POST["num_cont_factura"] != "") {
            $sql_cxp_factura = "INSERT INTO cxp_factura (
                ...
                VALUES (
                    ...
                    '{$_POST["input_tsiniva"]}', '{$_POST["input_tsiniva"]}', '0', '{$_POST["input_tciniva"]}', '{$_POST["input_tsiniva"]}',
                    '{$_POST["num_factura"]}', '{$_POST["_iva"][$i]}', '{$_POST["input_tiva"]}', '0', '0',
                    '" . $_POST["totalizar_monto_cancelar"] . "', '" . $_POST["num_factura"] . "', '1', '" . date("Y-m-d") . "', '" . $login->getUsuario() . "',
                    'FAC', '" . $_POST["num_factura"] . "', '1', '" . $_POST["num_factura"] . "', '" . $_POST["num_factura"] . "'
                )";
