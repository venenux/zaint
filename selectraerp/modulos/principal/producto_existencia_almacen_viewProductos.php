...
$string_cod_item_forma = " and cod_almacen = ".$codAlmacen;
...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * from vw_existenciabyalmacen where cod_almacen = ".$_GET["cod"];

}

$descripcion_almacen = $comunes->ObtenerFilasBySqlSelect("select * from almacen where cod_almacen = ".$_GET["cod"]);
...
$smarty->assign("descripcion_almacen",$descripcion_almacen);
$smarty->assign("registros",$campos);
$smarty->assign("cabecera",array("Cod. Item","Descripcion","Cantidad Existente",""));
