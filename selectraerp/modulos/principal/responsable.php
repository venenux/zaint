...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM responsable ";
}
...
$smarty->assign("cabecera",array("Cod.","Responsable"));
...
//**************************************************************************
$smarty->assign("option_values", array("cod_responsable","responsable"));
$smarty->assign("option_output", array("Cod. Responsable","Responsable"));
