...
if(isset($_POST["aceptar"]))
{
	...
	$campos_item = $productos->ObtenerFilasBySqlSelect("select id_item from item where cod_item = '".$_POST["cod_item"]."'");
	$instruccion="delete from servicios_islr where cod_item='".$campos_item[0]["id_item"]."'";
