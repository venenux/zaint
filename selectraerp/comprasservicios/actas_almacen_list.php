...
$url="actas_almacen_list";
$modulo="Actas de Almacen";
$tabla="ordenes";
...
if(isset($_POST['buscar']) || $tipob!=NULL){
	...
	switch($tipob){
		case "exacta":
			...
			$consulta=$consul."and  estado='Revisar' and tipo= 1";
			break;
		case "todas":
...
$consulta="select * from ".$tabla." where  tipo=1 and estado<>'Anulado'";
}
...
<table class="tb-head" width="100%">
  <tr>
	...
	<td><SELECT name="busqueda">
		...
		<option value="codigo">N&uacute;mero</option>
     </SELECT></td>
...
<?
	...
	$codigo=$fila["codigo"];
	icono("actas_almacen.php?codigo=$codigo", "Listar Actas","ico_add.gif");
	echo "</tr>";
	}
}else{
