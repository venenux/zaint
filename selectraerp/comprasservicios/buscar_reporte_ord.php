                  ...
                  <tr>
                    <th class="tb-fila" scope="col"><span>
                      <?php $conexion=conexion(); 
					  		$consulta="SELECT * FROM ordenes_tipos WHERE cod_orden_tipo = '".$var_tipo_orden."' ";
	...
	//echo $var_sql;
     ...
     <?php  if ($contador<>0 && $var_bandera == true){?>            </table>
                  <table width="200" border="1" align="center" class="tb-fila">
                    ...
                    <tr>
                      <td><div align="center"><a href="reporte_ord_general3.php?cod_orden_tipo=<?php echo $var_tipo_orden2; ?>&proveedor=<?php echo $var_proveedor2; ?>&estado=<?php echo $var_estado2; ?>&centro=<?php echo $var_centro2; ?>" target="_blank" ><img src="../imagenes/ico_print.gif" width="16" height="16" border="0" /></a></div></td>
                    </tr>
                  </table>
