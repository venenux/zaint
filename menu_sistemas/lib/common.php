...
function busqueda($url, $parametros, $array) {
    ...
    <? } ?>
            ...
            <td width="120"><input onclick="javascript:actualizar(this);" checked type="radio" name="palabra" value="exacta">Palabra exacta</td>
...
function conexion_formular() {
    ...
    if ($config[bd] == "mysql") {
        ...
        $base = mysql_select_db("selectraformulacion", $conexion);
        return $conexion;
    } else {
...
function encabezado($var_encabezado1, $var_encabezado2, $var_encabezado3, $var_encabezado4, $var_imagen_izq, $var_imagen_der) {
  ...
  <tbody>
    <tr>
      <td rowspan="4" align="center" valign="top" width="150" height="80"><img src="' . $var_imagen_izq . '" width="100" height="106"></td>
      <td width="400"><p align="center"><strong>' . $var_encabezado1 . '</strong></p></td>
      <td rowspan="4" align="center" valign="middle" width="150" height="80"><img src="' . $var_imagen_der . '" width="100" height="70"></td>
    </tr>
    <tr>
