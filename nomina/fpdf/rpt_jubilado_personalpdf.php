...
function detalle(){
	...
	$contenido='     Quien suscribe, Gerente General de Recursos Humanos, hace constar por medio de la presente que '.$ciu.$persona.', titular de la Cédula de Identidad Nº '.number_format($cedula,0,',','.').', laboró para esta Empresa desde el '.$fechaini.', siendo '.$ad.'a partir del '.$fechasus.', con el cargo de '.$cargo.', devegando actualmente una pensión mensual de '.$salarioletras.' (Bs. '.$salario.').';
