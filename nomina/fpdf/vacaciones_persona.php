...
function imprimir_tabla($ficha,$cedula,$pdf){
	$cantidad_registros=4;
	$conexion=conexion();
	$consulta="SELECT * from nompersonal WHERE ficha=$ficha and cedula=$cedula and tipnom=$_SESSION[codigo_nomina]";
...
$cedula=$_GET['cedula'];
$conexion=conexion();
$pdf->imprimir_tabla($ficha,$cedula,$pdf);
