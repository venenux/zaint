...
function detalle(){
	...
	$fechafin=$personal['fecharetiro'];
	
	list($anio,$mes,$dia)=explode("-",$fechafin);
	...
	$contenido='Quien suscribe, José Manuel García, titular de la cédula de identidad N� 10.736.726 en mi carácter de Director General del Despacho, hago constar que la (el) Ciudadana (o): '.$persona.', titular de la Cédula de Identidad Nº '.number_format($cedula,0,',','.').', presto sus servicios en la Fundación para el Avance Social (FUNDAVANZA), adscrita al Gobierno del Estado Carabobo desde el '.$fechaini.' hasta el  '.$fechafin.', desempeñando el cargo de '.$cargo.', devengando como último salario mensual la cantidad de '.$salarioletras.' (Bs. '.$salario.').';
