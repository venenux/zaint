<?php
class numerosALetras_html{
/*
Script Name: *numerosAletras_html
Script URI: http://www.mis-algoritmos.com/2007/09/07/numbers_to_words/
Description: Permite convertir numeros a letras mediante el uso de una sencilla clase  para usar con funciones de lectura html.
Script Version: 0.1
Author: Victor De la Rocha
Author URI: http://www.mis-algoritmos.com
*/
		var $resultado;
		var $antes_con_despues='bolívares con';
		var $despues = 'céntimos';
		var $antes_sin_despues='bolívares con 00/100';
		/*
			Constructor
		*/
		function numerosALetras_html($valor=''){
				if(is_numeric($valor))
		...
		*/
		function convertir($valor){
				...
				if($decimales){
					...
					//Para imprimir los acentos correctamente se le añade la funcion utf8_decode()
				return $this->resultado = utf8_decode($texto = ob_get_clean());
			}
