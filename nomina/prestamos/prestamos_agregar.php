...
{
	$consulta="INSERT INTO nomprestamos_cabecera SET numpre=$_POST[numpre], ficha=$_POST[ficha], fechaapro='".fecha_sql($_POST[fechaap])."', fecpricup='".fecha_sql($_POST[fecha1])."', monto=$_POST[montopre], estadopre='Pendiente', detalle='$_POST[descrip]', codigopr='$_POST[tipo]', codnom=$_SESSION[codigo_nomina], totpres=$_POST[montopre], cuotas=$_POST[numcuota], mtocuota=$_POST[montocuota]";
...
<tr class="tb-head"  style="font-weight : bold;"><td width="30%">Numero de prestamo:   <? echo $numpre;?><input type="hidden" name="numpre" id="numpre" value="<? echo $numpre;?>"></td>
