...
// 		unset($resultado_per);
		...
		where vac.fechavac<>'0000-00-00' and vac.fechareivac<>'0000-00-00' and vac.estado='Pendiente' and (vac.tipooper='DA' or vac.tipooper='DV') and cf.codfre='".$fila_nom['frecuencia']."' and pe.tipnom = '".$_SESSION['codigo_nomina']."' and ct.codtip = '".$_SESSION['codigo_nomina']."' and cs.estado = pe.estado and c.contractual='1'
