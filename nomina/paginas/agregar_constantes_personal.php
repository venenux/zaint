...
/////////////////////////////
$nombre_modulo='Campos Adicionales Trabajador';
$nombre_tabla='nomcampos_adicionales';
...
$campo_9='';
$campo_10='';
$documento_list='agregar_constantes_personal.php';
$documento_edit='agregar_constantes_personal.php';
...
{
	window.opener.document.forms[0].txtformula_aux.value="CAMPOADICIONALPER("+variable+")";
    ...
    <tr>
      <td class="row-br"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<strong>
			<font color="#000066">
			Constantes del Personal (Campos adicionales)</font></strong></td>
...
<label>&nbsp;&nbsp;
  ...
  <table width="95%" border="0" bordercolor="#0066FF" bgcolor="#FFFFFF" class="ewTable" id="lst"  cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#CCCCCC" class="ewTableHeader"> 
      ...
      <td width="82%" class="phpmakerlist"><div align="left"> <font size="2" face="Arial, Helvetica, sans-serif"> Descripci&oacute;n</font></div></td>
    </tr>	
     <?php 
  	...
  	?>
		...
		onClick="Aceptar('<?php echo $fila[$campo_1]; ?>')">
      <td> 
