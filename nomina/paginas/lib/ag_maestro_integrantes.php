...
'".fecha_sql($_POST['fecha_fin_contrato'])."','".fecha_sql($_POST['dfecing'])."','".fecha_sql($_POST['sfecing'])."','".$_POST['antiguedadap']."')";
...
<option>Seleccione una Profesi&oacute;n</option>
	...
	<tr bgcolor="">
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="dfecing" type="text" id="dfecing" style="width:100px" value="<?php echo $_POST['dfecing']; ?>" maxlength="60">
	...
	<tr bgcolor="">
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="sfecing" type="text" id="sfecing" style="width:100px" value="<?php echo $_POST['sfecing']; ?>" maxlength="60">
   	...
   	Calendar.setup({inputField:"sfecing",ifFormat:"%d/%m/%Y",button:"s_fec"}); 
        ...
        <tr bgcolor="">
          ...
          <td  ><font size="2" face="Arial, Helvetica, sans-serif">
            ...
            Contabilidad </font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
...
<input name="optContrato" id="optContrato" type="radio"  value="Fijo" onclick="javascript:mostrar_div_periodos(this.value)">
            Fijo
	...
	<script type="text/javascript"> 
   	Calendar.setup({inputField:"fecha_fin_contrato",ifFormat:"%d/%m/%Y",button:"d_fecha_fin_contrato"}); 
        ...
        <tr bgcolor="">
          ...
          <td  ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txtmonto" type="text" id="txtmonto" style="width:100px" value="<?echo $_POST['txtmonto']?>" maxlength="20"></font><font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font><font size="2" face="Arial, Helvetica, sans-serif"></font></td>
        </tr>
