...
function enviar(op,id){
	...
	if (op==1){		// Opcion de Agregar
		...
		document.frmAgregar.action="ag_tabulador_categorias.php";
...
elseif ($cadena <> ""){ // Condicion para filtrado
		...
		$strsql="select COUNT(*) from nomgrupos_categorias";
		$strsql=filtrado($criterio,$cadena,$strsql,"gr","salario","bonomes","bonodia");		
		$result =sql_ejecutar($strsql);			
		$fila = mysql_fetch_array($result);	
		$num_total_registros = $fila[0];	
	
		$strsql="select * from nomgrupos_categorias";
		$strsql=filtrado($criterio,$cadena,$strsql,"gr","salario","bonomes","bonodia");		
	...
	$strsql= "select * from nomgrupos_categorias order by gr,salario LIMIT $TAMANO_PAGINA OFFSET $limit";
	$result =sql_ejecutar($strsql);		
    $total_paginas = ceil($num_total_registros / $TAMANO_PAGINA);
}
?>
...
<form action="" method="post" name="frmPrincipal" id="frmPrincipal">
    ...
    <tr>
      <td class="row-br"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<strong>
			<font color="#000066">
			Tabulador para Categorias </font></strong></td>
            ...
            <td width="2%" align="right"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td>
				    <div align="right">
				      <?php btn('add','ag_tabulador_categorias.php') ?>				        
		            </div></td>
                </tr>
            </table></td>
          </tr>
  ...
  <table width="100%" border="0" class="ewTableHeader">
    <tr class="">
      ...
      <td width="17"><font size="2" face="Arial, Helvetica, sans-serif" class="ewTableHeader">
        <?php btn('show_all','tabulador_categorias.php?cmd=reset') ?>
      </font></td>
...
<label>
  ...
  <table width="100%" border="0" bordercolor="#0066FF" bgcolor="#FFFFFF" class="ewTable" id="lst"  cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#CCCCCC" class="ewTableHeader"> 
    	<td width="7%" height="21" align="right" class="phpmakerlist"> 
			<div align="left" class="tb-head">
	  <font size="2" face="Arial, Helvetica, sans-serif"> Grupo  </font></div>	  </td>
		
        <td width="26%" class="phpmakerlist"><font size="2" face="Arial, Helvetica, sans-serif">Salario </font></td>
        <td width="27%" class="phpmakerlist">Bono Mes </td>
        <td width="31%" class="phpmakerlist">
  	  <div align="left">Bono D&iacute;a </div>	  </td>
    ...
    <tr> 
      ...
      <td height="20" bgcolor="#DFDFDF" class="ewTableRow"> <div align="left" class="row-even"><font size="2" face="Arial, Helvetica, sans-serif">	
          <?php 
		  echo $fila[gr]; 	// codigo del cargo
		  ?>
      </font></div></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><font size="2" face="Arial, Helvetica, sans-serif">
        <?php 
	  		echo $fila[salario];  	// salario del grupo
	  	?>
      </font></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><font size="2" face="Arial, Helvetica, sans-serif">
        <?php 
	  		echo $fila[bonomes];  	// bono del mes
	  	?>
      </font></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif"> 
          
          <?php 
	  		echo $fila[bonodia];  	// bono del dia
	  	?>
      </font></div></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="javascript:enviar(<?php echo(2); ?>,<?php echo($fila[gr]); ?>);"><img src="img_sis/ico_edit.gif" title="Modificar el Registro Actual" width="16" height="16" border="0" align="absmiddle"></a>
        <label></label>
      </font></div></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><font size="2" face="Arial, Helvetica, sans-serif"><img src="img_sis/ico_ok.gif" title="Procesar el Registro Actual" width="15" height="15" border="0" align="absmiddle"></a></font></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><a href="javascript:enviar(<?php echo(3); ?>,<?php echo($fila[gr]); ?>);"><img src="../imagenes/delete.gif" title="Eliminar el Registro Actual" width="16" height="16" border="0" align="absmiddle" ></a></font></div></td>
    </tr>
    <?php   
  	}//fin del ciclo while
  ...
  <table width="100%" height="31" class="tb-footer">
	...
	?>
        ...
        <tr>
          ...
          <?php } else { ?>
          <td><a href="tabulador_categorias.php?pagina=1&criterio=<?php $criterio;?>"><img src="images/first.gif" title="Primera" width="16" height="16" border="0"></a></td>
          <?php } ?>
          <!--previous page button-->
          <?php if ($PrevStart == $inicio) { ?>
          <td><img src="images/prevdisab.gif" title="Anterior" width="16" height="16" border="0"></td>
          <?php } else { ?>
          <td><a href="tabulador_categorias.php?pagina=<?php echo $pagina-1; ?>&criterio=<?php $criterio;?>"><img src="images/prev.gif" title="Anterior" width="16" height="16" border="0"></a></td>
          <?php } ?>
          <!--current page number-->
          ...
          <?php } else { ?>
          <td><a href="tabulador_categorias.php?pagina=<?php echo $pagina+1; ?>&criterio=<?php $criterio;?>"><img src="images/next.gif" title="Siguiente" width="16" height="16" border="0"></a></td>
          <?php  } ?>
          <!--last page button-->
          <?php if ($NextStart == $inicio) { ?>
          <td><img src="images/lastdisab.gif" title="Ultima" width="16" height="16" border="0"></td>
          <?php } else {?>
          <td><a href="tabulador_categorias.php?pagina=<?php  echo $LastStart; ?>&criterio=<?php $criterio;?>
