...
$documento_atras='submenu_bancos.php';
///////////////////////////////
?>
<script>
...
<label>
  ...
  <table width="100%" border="0" bordercolor="#0066FF" bgcolor="#FFFFFF" class="ewTable" id="lst"  cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#CCCCCC" class="ewTableHeader"> 
    	<td width="10%" height="21" align="right" class="phpmakerlist"> 
			<div align="left" class="tb-head">
	  <font size="2" face="Arial, Helvetica, sans-serif"> Codigo  </font></div>	  </td>
		
        <td width="50%" class="phpmakerlist"><font size="2" face="Arial, Helvetica, sans-serif">Descripci&oacute;n de</font>l Banco </td>
      <td width="34%" class="phpmakerlist">
	  	<div align="left">Sucursal</div>	  </td>
