...
<script>
function AbrirSueldoPromedio(id,nom)
{
location.href='../fpdf/rpt_sueldo_promedio.php?registro_id='+id+'&tipN='+nom
...
<input name="optOpcion" type="radio" id="Contenga"  value="Contenga"   checked="true"
    ...
    <tr> 
  	...
  	?>
     		 <td height="20" bgcolor="#DFDFDF" class="ewTableRow"> <div align="left" class="row-even"><font size="2" face="Arial, Helvetica, sans-serif">	
          		<?php   echo $fila[cedula]; 	// cedula de identidad ?>
      		</font></div></td>

      		<td bgcolor="#DFDFDF"  class="ewTableRow"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif">
        	<?php   echo $fila[ficha]; 	// ficha del integrante	  ?>
      		</font></div></td>
     		
		 <td bgcolor="#DFDFDF" class="ewTableRow"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif">           
          	<?php echo $fila[apellidos].', '.$fila[nombres];  	// apellidos y nombres 	?>
     		 </font></div></td>
		...
		<a href="
		<?php if ($tipo==1){ ?> 
			javascript:AbrirSueldoPromedio('<?php echo $fila[ficha]; ?>','<?php echo $_SESSION['codigo_nomina'];?>');
	 	<?php } ?>
		"><img src="img_sis/ico_list.gif" alt="Ver Sueldo Promedio" width="15" height="15" border="0" align="absmiddle"></a>
        	<label></label>
      		</font></div></td>
  ...
  <table width="100%" height="31" class="tb-footer" border="0">
    <tr>
	...
	?>
        ...
        <tr>
          ...
          <?php } else { ?>
          <td><a href="list_personal_general.php?pagina=1&criterio=<?php $criterio;?>&tipo=<? echo $tipo;?>"><img src="images/first.gif" alt="Primera" width="16" height="16" border="0"></a></td>
          <?php } ?>
          <!--previous page button-->
          <?php if ($PrevStart == $inicio) { ?>
          <td><img src="images/prevdisab.gif" alt="Anterior" width="16" height="16" border="0"></td>
          <?php } else { ?>
          <td><a href="list_personal_general.php?pagina=<?php echo $pagina-1; ?>&criterio=<?php $criterio;?>&tipo=<? echo $tipo;?>"><img src="images/prev.gif" alt="Anterior" width="16" height="16" border="0"></a></td>
          <?php } ?>
          <!--current page number-->
          ...
          <?php } else { ?>
          <td><a href="list_personal_general.php?pagina=<?php echo $pagina+1; ?>&criterio=<?php $criterio;?>&tipo=<? echo $tipo;?>"><img src="images/next.gif" alt="Siguiente" width="16" height="16" border="0"></a></td>
          <?php  } ?>
          <!--last page button-->
          <?php if ($NextStart == $inicio) { ?>
          <td><img src="images/lastdisab.gif" alt="Ultima" width="16" height="16" border="0"></td>
          <?php } else {?>
          <td><a href="list_personal_general.php?pagina=<?php  echo $LastStart; ?>&criterio=<?php $criterio;?>&tipo=<? echo $tipo;?>
