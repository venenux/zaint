...
nomconceptos_tiponomina.codtip='".$_SESSION['codigo_nomina']."' group by nomconceptos.tipcon, nomconceptos.codcon, nomconceptos.descrip order by nomconceptos.tipcon,nomconceptos.descrip";
}
...
function Aceptar(variable)
{
	...
	window.opener.document.forms[0].concepto.value=variable;
	CerrarVentana();
}
function enviar(op){
