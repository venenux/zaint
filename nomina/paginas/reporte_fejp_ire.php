...
<tbody>
<tr>
	<td align="center"><strong>RELACI&Oacute;N DE APORTES Y COTIZACIONES AL</strong></td>
</tr>
<tr>
	<td align="center"><strong>FONDO ESPECIAL DE JUBILACIONES Y PENSIONES</strong></td>
</tr>
<tr>
  ...
  <tbody>
    <tr style="border-bottom-style : solid; border-bottom-width : 1px; font-weight : bold;">
      ...
      <td align="center" width="80">Sueldo Mensual</td>
		...
		<td align="center" width="80">Aporte Patronal 3% 4.01.06.03.00</td>
      <td align="center" width="80">Cotizaci&oacute;n Trabajador 3%</td>
		<td align="center" width="80">Total 6%</td>
...
while($fila=fetch_array($resultado))
{
	...
	while($nominas = fetch_array($resultado12))
	{
		...
		$consulta="select monto from nom_movimientos_nomina where cedula='".$fila['cedula']."' and ficha='".$fila['ficha']."'  and codnom='".$nominas['codnom']."' and tipnom = '".$nominas['tipnom']."' and codcon='2001' ";
...
<td align="center" width="80">Aporte Patronal 3% 4.01.06.11.00</td>
<td align="center" width="80">Cotizaci&oacute;n Trabajador 3%</td>
<td align="center" width="80">Total 6%</td>
</tr>
              <?  
     ...
     <td align="center" width="250">Apellidos y Nombres</td>
          ...
          ?>      
           ...
           ?> 
            ...
            ?>
          <td align="center" width="80">Cotizaci&oacute;n Trabajador 3%</td>
            <td align="center" width="80">Total 3%</td>
        </tr>
