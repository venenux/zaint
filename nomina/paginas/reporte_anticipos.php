...
<tr>
<td align="center" style="font-size : 14px;">ANTICIPOS DE PRESTACIONES SOCIALES AL <?echo date("d/m/Y");?></td>
</tr>
</table>
...
<td width="100" align="center"><font size="2" face="Arial, Helvetica, sans-serif">MONTO</font></td>
<td width="100"><font size="2" face="Arial, Helvetica, sans-serif">FECHA</font></td>
</tr>
...
{
	$consulta="SELECT fecha_salida, monto_nuevo FROM nomexpediente WHERE cedula=$fila[cedula] AND tipo_registro='Antic. prestaciones'";
