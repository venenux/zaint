...
{	
	...
	$query="UPDATE nomelegibles SET cedula = '".$_POST['txtcedula']."',foto = 'fotos/".$nombre_archivo1."',apellidos = '".$_POST['txtapellidos']."',nombres = '".$_POST['txtnombres']."',sexo = '".$_POST['optSexo']."',fecnac = '".$fecha."',lugarnac = '".$_POST['txtlugarNac']."',telefono = '".$_POST['txttelefonos']."', direccion = '".$_POST['txtdireccion']."', email = '".$_POST['txtemail']."', cod_profesion = '".$_POST['cboProfesion']."', grado_instruccion = '".$_POST['cboInstruccion']."', area_desempeno = '".$_POST['txtaread']."', anios_exp = '".$_POST['txtanosex']."', observacion = '".$_POST['txtobs']."', fecha_reg = '".$fecha2."' WHERE cedula = '".$_POST['txtcedula']."' ";
	...
	if ($result2=mysql_query($query,$conexion))
	{
		?>
			...
			location.href="elegibles_list.php"
			</script>
		<?
	}
	else
...
$consulta33 = "SELECT * FROM nomelegibles WHERE cedula = '".$cedula."' ";
$resultado33 = mysql_query($consulta33,$conexion); 
$fetch33 = mysql_fetch_array($resultado33);


		  
$query44="select * from nomprofesiones where codorg = '".$fetch33['cod_profesion']."'";
$result44=mysql_query($query44,$conexion);		
$row44 = mysql_fetch_array($result44);
    
  
$query55="select * from nominstruccion WHERE codigo = '".$fetch33['grado_instruccion']."'";
$result55=mysql_query($query55,$conexion);
$row55 = mysql_fetch_array($result55);
  		
$query66="select * from nomdesempeno WHERE codigo = '".$fetch33['area_desempeno']."'";
$result66=mysql_query($query66,$conexion);
...
<form action="curriculum_edit.php" method="post" name="frmAgregarIntegrantes" id="frmAgregarIntegrantes" enctype="multipart/form-data">
<input name="op_tp" type="Hidden" id="op_tp" value="-1">
<input name="registro_id" type="Hidden" id="registro_id" value="<?php echo $_POST[registro_id]; ?>">

<table align="center" width="700" border="0">
<tbody>
<tr><TD colspan="3" class="tb-tit" align="right"><? echo btn("back","elegibles_list.php")?></TD>
</tr>
<tr><TD colspan="3"><br></TD></tr>
    <tr>
      
      <td rowspan="7"><img src="<? echo $fetch33['foto']; ?>" lowsrc="<? echo $fetch33['foto']; ?>" border="1" name="imgFoto" id="imgFoto" width="177" height="179" align="middle" class="" style="top:0px"></td>
    </tr>
 
    <tr>
      <td>Archivo de Foto:</td>
      <td><input type="file" name="mifichero" id="mifichero" onchange="javascript:Actualizar_Foto();" value="" style="width:320px" ><input name="txtrutafoto" type="hidden" id="txtrutafoto" value="" maxlength="60"></td>
    </tr>
<tr>
      <td></td>
      <td></td>
...
<table align="center" width="700" border="0" class="">
          ...
          <td><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txtFecha" type="text" id="txtFecha" style="width:100px" value="<?php echo fecha($fetch33['fecha_reg']); ?>" maxlength="60" onblur="javascript:actualizar('','');">
  ...
  <script type="text/javascript">Calendar.setup({inputField:"txtFecha",ifFormat:"%d/%m/%Y",button:"d_fecha"});</script>
        ...
        <tr >
          ...
          <td width="500" ><font size="2" face="Arial, Helvetica, sans-serif"><input name="txtapellidos" type="text" id="txtapellidos" style="width:200px" value="<?php echo $fetch33['apellidos']; ?>" maxlength="30">
          </font></td>
        </tr>
        <tr bgcolor="">
          <td ><font size="2" face="Arial, Helvetica, sans-serif">Nombres</font>:</td>
          <td ><font size="2" face="Arial, Helvetica, sans-serif"><input name="txtnombres" type="text" id="txtnombres" style="width:200px" value="<?php echo $fetch33['nombres']; ?>" maxlength="30">
          </font></td>
        </tr>
<tr >
          <td ><font size="2" face="Arial, Helvetica, sans-serif">C&eacute;dula:</font></td>
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txtcedula" type="text" id="txtcedula" style="width:100px" value="<? echo $fetch33['cedula']?>" maxlength="10">
          </font></td>
        </tr>
        ...
        <tr>
          ...
          <td><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txtFechaNac" type="text" id="txtFechaNac" style="width:100px" value="<?php echo fecha($fetch33['fecnac']); ?>" maxlength="60" onblur="javascript:actualizar('txtFechaNac','fila_edad');">
  ...
  <script type="text/javascript">Calendar.setup({inputField:"txtFechaNac",ifFormat:"%d/%m/%Y",button:"d_fechanac"});</script>
        ...
        <tr >
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            ...
            <input name="txtlugarNac" type="text" id="txtlugarNac" style="width:200px" value="<?php echo $fetch33['lugarnac']; ?>" maxlength="20">
          </font></td>
        </tr>
        <tr bgcolor="">
...
<option value="<?php echo $row44['codorg'];?>"><?php echo $row44['descrip'];?></option>
              <?php
...
<option value="<?php echo $row55['codigo'];?>"><?php echo $row55['descripcion'];?></option>
              <?php
...
<tr bgcolor="">
 ...
 <option value="<?php echo $row66['codigo'];?>"><?php echo $row66['descripcion'];?></option>
              <?php
		...
		?>
		 ...
		 <tr bgcolor="">
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txtanosex" type="text" id="txtanosex" style="width:50px"  value="<?php echo $fetch33['anios_exp']; ?>" maxlength="2" >
          </font></td>
        </tr>
        ...
        <tr >
          ...
          <td  ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txttelefonos" type="text" id="txttelefonos" style="width:200px" value="<?php echo $fetch33['telefono']; ?>" maxlength="20">
          </font></td>
        ...
        <tr bgcolor="">
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="txtemail" type="text" id="txtemail" style="width:200px"  value="<?php echo $fetch33['email']; ?>" maxlength="40" >
          </font></td>
        </tr>
       <tr bgcolor="">
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <textarea cols="50" rows="5" name="txtdireccion" id="txtdireccion"><?php echo $fetch33['direccion']; ?></textarea>
          </font></td>
		...
		<tr bgcolor="">
          ...
          <td ><font size="2" face="Arial, Helvetica, sans-serif">
            <textarea cols="50" rows="5" name="txtobs" id="txtobs"><?php echo $fetch33['observacion']; ?></textarea>
          </font></td>
