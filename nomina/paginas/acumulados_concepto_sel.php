...
<td width="15%" >Concepto: <input type="text" name="concepto" id="concepto" align="right" maxlength="5"  size="8"/>&nbsp;
<a href="javascript:buscar_concepto();"> <img src="images/search.gif" name="buscar" id="buscar" border="0" /></a></td>
