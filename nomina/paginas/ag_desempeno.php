...
<?php 
	...
	{			
		...
		if ($op_tp==1)
		{
		$codigo_nuevo=AgregarCodigo("nomdesempeno","codigo");
		
		$query="insert into nomdesempeno values 
		($codigo_nuevo,
	...
	{	
		$query="select * from nomdesempeno where codigo=$registro_id";		
		$result=sql_ejecutar($query);	
	...
	if ($op_tp==2)
		{							
				$query="UPDATE nomdesempeno set codigo=$registro_id,
  ...
  <table width="780" height="125" border="0" class="row-br">
    <tr>
      <td height="31" class="row-br"><font color="#000066"><strong>&nbsp;<font color="#000066">
		...
		if ($registro_id==0)
		{
		echo "Agregar area de desempeño";
		}
		else
		{
		echo "Modificar area de desempeño";
		}
		?>
      </font></strong></font></td>
    </tr>
