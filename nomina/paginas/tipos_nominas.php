...
function enviar(op,id){
	...
	if (op==1){		// Opcion de Agregar
		...
		document.frmPrincipal.action="ag_tiposnomina.php";
...
if ($op==3) //Se presiono el boton de Eliminar
	...
	$query="delete from nomtipos_nomina where codtip=$registro_id";	
...
elseif ($cadena <> "") 		// Condicion para filtrado
	{   
		...
		$strsql="select COUNT(*) from nomtipos_nomina";
		$strsql=filtrado($criterio,$cadena,$strsql,"codtip","descrip");		
...
else					// No se filtra y se muestran todos los datos
{
	...
	//$strsql= "select * from nomtipos_nomina order by codtip,descrip LIMIT $TAMANO_PAGINA OFFSET $inicio";
	
	$strsql= "select * from nomtipos_nomina order by codtip,descrip LIMIT $TAMANO_PAGINA OFFSET $limit";
	$result =sql_ejecutar($strsql);		
    $total_paginas = ceil($num_total_registros / $TAMANO_PAGINA);
}
?>
...
<form action="" method="post" name="frmPrincipal" id="frmPrincipal">
  ...
  <table width="100%" border="0" class="ewTableHeader">
    <tr class="">
      ...
      <td width="17"><font size="2" face="Arial, Helvetica, sans-serif" class="ewTableHeader">
        <?php btn('show_all','tipos_nominas.php?cmd=reset') ?>
      </font></td>
...
<label>
  ...
  <table width="100%" border="0" bordercolor="#0066FF" bgcolor="#FFFFFF" class="ewTable" id="lst"  cellspacing="0" cellpadding="0">
    ...
    <tr bgcolor="#CCCCCC" class="ewTableHeader"> 
      ...
      <td width="70%" class="phpmakerlist">
	  	<div align="left">
	  Descripci&oacute;n de <?echo $termino?> </div>	  </td>
    ...
    <tr> 
	  ...
	  <a href="javascript:enviar(<?php echo(2); ?>,<?php echo($fila[codtip]); ?>);"><img src="img_sis/ico_edit.gif" title="Modifica el Registro Actual" width="16" height="16" border="0" align="absmiddle"></a>
        <label></label>
      </font></div></td>
      <td bgcolor="#DFDFDF" class="ewTableRow" onclick="javascript:alert('Esta funcion no se encuentra implementada')"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
	  <img src="img_sis/ico_propiedades.gif" title="Asignar a Conceptos" width="15" height="15" border="0" align="absmiddle" >
              <label></label>
      </font></div></td>
      <td bgcolor="#DFDFDF" class="ewTableRow" onclick="javascript:alert('Esta funcion no se encuentra implementada')"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><img src="img_sis/ico_user.gif" title="Asignar a Personal" width="17" height="15" border="0" align="absmiddle">
              <label></label>
      </font></div></td>
      <td bgcolor="#DFDFDF" class="ewTableRow"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
	  <a href="javascript:enviar(<?php echo(3); ?>,<?php echo($fila[codtip]); ?>);"><img src="../imagenes/delete.gif" title="Elimina el Registro Actual" width="16" height="16" border="0" align="absmiddle" ></a></font></div></td>
    </tr>
    <?php   
  	}//fin del ciclo while
  ...
  <table width="100%" height="31" class="tb-footer">
	...
	?>
        ...
        <tr>
          ...
          <?php } else { ?>
          <td><a href="tipos_nominas.php?pagina=1&criterio=<?php $criterio;?>"><img src="images/first.gif" title="Primera" width="16" height="16" border="0"></a></td>
          <?php } ?>
          <!--previous page button-->
          <?php if ($PrevStart == $inicio) { ?>
          <td><img src="images/prevdisab.gif" title="Anterior" width="16" height="16" border="0"></td>
          <?php } else { ?>
          <td><a href="tipos_nominas.php?pagina=<?php echo $pagina-1; ?>&criterio=<?php $criterio;?>"><img src="images/prev.gif" title="Anterior" width="16" height="16" border="0"></a></td>
          <?php } ?>
          <!--current page number-->
          ...
          <?php } else { ?>
          <td><a href="tipos_nominas.php?pagina=<?php echo $pagina+1; ?>&criterio=<?php $criterio;?>"><img src="images/next.gif" title="Siguiente" width="16" height="16" border="0"></a></td>
          <?php  } ?>
          <!--last page button-->
          <?php if ($NextStart == $inicio) { ?>
          <td><img src="images/lastdisab.gif" title="Ultima" width="16" height="16" border="0"></td>
          <?php } else {?>
          <td><a href="tipos_nominas.php?pagina=<?php  echo $LastStart; ?>&criterio=<?php $criterio;?>
