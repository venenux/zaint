...
<table align="center" width="700" border="0" class="">
		  ...
		  <tr>
          <td ><font size="2" face="Arial, Helvetica, sans-serif">Tipo: </font></td>
          <td ><span ><font size="2" face="Arial, Helvetica, sans-serif">
            <input name="opttipo" type="radio" value="anterior" >Anterior<input name="opttipo" type="radio" value="actual">
            Actual</font></span></td>
        </tr>

        <tr >
          <td width="200"><font size="2" face="Arial, Helvetica, sans-serif">Adiestramiento</font></td>
