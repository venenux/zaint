...
function relacion_calculo_antiguedad()
{
	//alert(document.form1.cboTipoNomina.value);
	AbrirVentana('reporte_calculo_antiguedad_ire.php?mes='+document.form1.fechaD.value,660,850,0);
}
function relacion_calculo_aguinaldos()
{
	//alert(document.form1.cboTipoNomina.value);
	AbrirVentana('reporte_calculo_aguinaldos_ire.php?mes='+document.form1.fechaD.value,660,850,0);
}
function relacion_calculo_bono_vacacional()
{
	//alert(document.form1.cboTipoNomina.value);
	AbrirVentana('reporte_calculo_bono_vacacional_ire.php?mes='+document.form1.fechaD.value,660,850,0);
}
function relacion_aporte_emp_obr()
{
	//alert(document.form1.cboTipoNomina.value);
	AbrirVentana('reporte_aporte_emp_obr_ire.php?mes='+document.form1.fechaD.value,660,850,0);
}
    ...
    <tr>
      <td height="31" class="row-br"><table width="789" border="0">
          <tr>
            ...
            <td width="17"><div align="center"><?php btn('back','submenu_reportes_nomina.php')  ?></div></td>
          </tr>
        </table>
        </td>
    </tr>
              ...
              <?php 
				...
				switch($valor){
					...
					case "fejp":
						...
						break;
					case "calcantig":
						btn('ok','relacion_calculo_antiguedad();',2);
						break;
					case "calcagui":
						btn('ok','relacion_calculo_aguinaldos();',2);
						break;
					case "calcbv":
						btn('ok','relacion_calculo_bono_vacacional();',2);
						break;
					case "aportempobr":
						btn('ok','relacion_aporte_emp_obr();',2);
						break;
				}
  ?>
            </div></td>
