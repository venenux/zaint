...
<table align="center">
  <tbody>
    <tr>
      <td align="center"><strong>RELACI&Oacute;N DEL APORTE PATRONAL Y COTIZACIONES DE EMPLEADOS Y</strong></td>
    </tr>
    <tr>
      <td align="center"><strong>OBREROS AL FONDO DE AHORRO HABITACIONAL</strong></td>
    </tr>
    <tr>
  ...
  <tbody>
    <tr style="border-bottom-style : solid; border-bottom-width : 1px; font-weight : bold;">
      ...
      <td align="center" width="80">Sueldo Mensual</td>
		<td align="center" width="80">Aporte Patronal 2% 4.01.06.05.00</td>
      <td align="center" width="80">Cotizaci&oacute;n Trabajador 1%</td>
...
while($fila=fetch_array($resultado))
{
	...
	while($nominas = fetch_array($resultado12))
	{
		...
		$consulta="select monto from nom_movimientos_nomina where cedula='".$fila['cedula']."' and ficha='".$fila['ficha']."'  and codnom='".$nominas['codnom']."' and tipnom = '".$nominas['tipnom']."' and codcon='2003' ";
...
<td align="center" width="50">C&eacute;dula</td>
<td align="center" width="80">Sueldo Mensual</td>
<td align="center" width="80">Aporte Patronal 2% 4.01.06.13.00</td>
<td align="center" width="80">Cotizaci&oacute;n Trabajador 1%</td>
<td align="center" width="80">Total 3%</td>
</tr>
              <?  
