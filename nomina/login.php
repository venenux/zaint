...
<form action="login.php" method="post" onSubmit="return EW_checkMyForm(this);">
  <table  border="1" align="center" cellpadding="0" cellspacing="3" bgcolor="#FFFFFF">
    ...
    <tr>
            ...
            <td align="center" ><a target="_self" href="../selectra/sistemas.php" ><img src="img_sis/back.png" border="0" width="16" height="16" align="absmiddle"/>&nbsp;Ir a menu de Sistemas</a></td>
    </tr>
    </table>
