...
<LINK href="parametros_archivos/estilos.css" type="text/css" rel="stylesheet">
  ...
  <TR>
    <TD class=row-br>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD><SPAN style="FLOAT: left"><IMG class=icon height=32 src="menu_archivos/9.png" 
            width=32>Balance General</SPAN></TD>
          <TD align=right>
  ...
  <TR>
    <TD class=row-br>
      ...
      <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
        <TBODY>
        <TR>
          <TD colspan="6"><form action="rep_balgenlist_num.php" method="post" name="Editar" target="_blank">
            <pre>
...
<!--Hasta: <input  <?php 
                     $Retornador = 'http://selectra.asys.com.ve/contabilidad/frame_archivos/rep_balgen_pre.php#';
				   ?>
...
-->
Hoja reporte: <select name="Hoja" id="Hoja"><option value="<?php echo "$Balact"?>">ACTIVO</option><option value="<?php echo "$Balpas"?>">PASIVO</option></select>  
