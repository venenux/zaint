  ...
  <TR>
    <TD class=row-br>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD><SPAN style="FLOAT: left"><IMG class=icon height=32 src="menu_int_archivos/14.png" 
            width=32>Diario General</SPAN></TD>
          <TD align=right>
  ...
  <TR>
    <TD class=row-br>
      ...
      <TABLE cellSpacing=0 cellPadding=4 width="100%" border=0>
        <TBODY>
        <TR>
          <TD colspan="6"><form action="rep_diagenlist_num.php" method="post" name="Editar" target="_blank">
            <pre>
...
<!--Desde:<input      <?php 
                     $Retornador = 'http://selectra.asys.com.ve/contabilidad/frame_archivos/rep_diagen_pre.php#';
				   ?>
