...
function ultimodia($anho,$mes)
{
   ...
   switch($mes) {
	...
	$fecha = $feca."-".$fecm."-".$d;
	$consultac = "SELECT * FROM activosfijos_movimientos WHERE FECMOV = '".$fecha."'";
...
<table width="100%" border="0" align="center">
  <tbody>
	...
	<TABLE width="100%" align="center" border="0">
		...
		<TR>
			<TD colspan="3" align="center"><strong>(movimientos)</strong></TD>
		</TR>
	...
	<TABLE width="100%" border="0" style="border-style:solid; border-color:#333333;">
    	<TR>
			...
			><TD align=left style="font-size:11px;"><strong>Fecha</strong></TD>
			<!--<TD align=center style="font-size:11px;"><strong>CCO</strong></TD>-->
			<TD align=right style="font-size:11px;"><strong>Monto</strong></TD>
			...
			<?
				...
				{	
						...
						<td align=center style="font-size:10px;"><strong>'.$fila['TIPOMOV'].'</strong></td>
						<td align=left style="font-size:10px;"><strong>'.fecha($fila['FECMOV']).'</strong></td>
						
						<td align=right style="font-size:10px;"><strong>'.number_format($fila['MONMOV'],2,',','.').'</strong></td>
						
						</tr>';
						$totaldpr+=$fila['MONMOV'];
						$i+=1;
