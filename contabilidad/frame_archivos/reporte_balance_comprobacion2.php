	...
	//echo $result;
   	...
   	{  	
		...
		else
		{
			...
			$result_ant = mysql_query("SELECT SUM(Credito) AS Credsum, SUM(Debito) AS Debsum  FROM cwcondco WHERE Cuenta LIKE '$Cuenta%' AND Fecha BETWEEN '$Fecini' AND '$fechahastasalant'", $conectar); 
