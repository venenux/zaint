...
//echo $conexion;
$url="tipo_activo";
$modulo="Tipo de Activos";
$tabla="activosfijos_tipos";
$titulos=array("C&oacute;digo","Descripci&oacute;n");
$indices=array("CODIGOTA","DESCRIP");
...
if(isset($_POST['buscar']) || $tipob!=NULL){
	...
	if ($eliminar == '1') 
	{
		$var_sql="delete from ".$tabla." WHERE CODIGOTA ='".$codigo."'";
...
<?
	titulo($modulo,"tipo_activo_add.php","menu_activos.php","46");
?>
<table class="tb-head" width="100%">
  <tr>
	<td><input type="text" name="buscar" size="20"></td>
	<TD><SELECT name="busqueda">
       	<option value="CODIGOTA">C&oacute;digo</option>
...
<?
	...
	icono("tipo_activo_edit.php?id=".$id."&pagina=".$pagina, "Editar Tipo de Activo", "edit.gif");
