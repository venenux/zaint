...
/*
	...
	echo $var_imagen_izq = $row_rs['imagen_izq'];
...
*/
	...
	$consulta = "SELECT * FROM activosfijos order by CODCCOS,TIPO ";
...
<table width="100%" border="0" align="center">
  <tbody>
	...
	<TABLE width="100%" align="center" border="0">
		...
		<TR>
			<TD colspan="3" align="center"><strong>(general)</strong></TD>
		</TR>
...
<table width="100%" border="0" align="center">
  <tbody>
	...
	<TABLE width="100%" align="center" border="0">
		...
		<TR>
			<TD align="right" colspan="3"><strong>P&aacute;gina: <? ++$paginas;?></strong> </TD>
		</TR>
		<TR>
			<TD colspan="3" align="center"><strong>ACTIVOS FIJOS </strong></TD>
		</TR>
