...
datos_cuenta_pt($Cuenta_niv1,'PASIVO + CAPITAL + RESULTADOS',$Salantu_float_format_niv1,$Debito_float_format_niv1,$Credito_float_format_niv1,$Salmes_float_format_niv1,$pasres);
