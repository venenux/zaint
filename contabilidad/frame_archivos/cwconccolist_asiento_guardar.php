...
<?
titulo("Centros de costo disponibles","","menu_int.php","6");
?>
  ...
  { 
	...
	if($i%2==0){
        ...
        echo "<td>".$row["Codccos"]."</td><td>".$row["Descrip"]."</td>"; 
          echo '<TD noWrap width="1%"><A href="cwconccolist_asiento.php?Codccos='.$row["Codccos"].'&accion=guardar&Numcom='.$Numcom.'&Asiento='.$Asiento.'&pagina='.$pagina.'&feccom='.$feccom.'">';
