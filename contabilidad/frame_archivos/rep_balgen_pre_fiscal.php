<?
	...
	if(isset($_POST['enviar']))
	{
		...
		//header("http://localhost:8080/selectra/mostrar_reportes.jsp?cuenta_inicio=".$_POST['cuenta_inicio']."&cuenta_fin=".$_POST['cuenta_fin']."&fecha_inicial=".$fecha_inicio."&fecha_final=".$fecha_final."&saldo_anterior=0"); 
			...
			location.href=\"reporte_balance_general.php?nivel_cuenta=".$nivel_cuenta."&mes=".$mes_ini."&mes_fin=".$mes_fin."\"</SCRIPT>";
		//}
		//}
...
<FORM name="sampleform" method="POST" target="_blank" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	<?titulo("Seleccione Datos del Reporte","","reportes_fiscales.php?","70");?>
	<BR>
...
?> 
		...
		<TR>
			<TD class="tb-fila" width="40">Seleccione el Mes de Inicio: </TD>
			<TD colspan="2"><SELECT name="mes_ini" id="mes_ini">
		...
		<TR>
			<TD class="tb-fila" width="40">Seleccione el Mes Final: </TD>
			<TD colspan="2"><SELECT name="mes_fin" id="mes_fin">
					<option value="0">Seleccione..</option>
					<option value="1">Enero</option>
					<option value="2">Febrero</option>
					<option value="3">Marzo</option>
