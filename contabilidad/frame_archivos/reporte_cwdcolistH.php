...
include ("header.php");
	...
	$consulta_pag="select * from cwcondcohis where Numcom=".$Numcom;
...
function imprimir_datos($pagina,$num_paginas,$Numcom,$Nombre)
{
	...
	$consulta_com="SELECT * FROM cwconhcohis where Numcom=".$Numcom;
	...
	<table width="800" border="0" align="center">
		...
		<tr>
			...
			<td width="400" align="justify" class="texto10" rowspan="2">Nro: '.$Numcom.' '.$Nombre.'</td>
...
<br><br>
	...
	<tr style="border-bottom-style : outset; border-left-style : outset; border-right-style : outset; border-top-style : outset;">
        <td width="180" align="left"><strong>Cuenta</strong></td>
	<td width="30" align="center"><strong>Ref</strong></td>
	<td width="30" align="center"><strong>Tipo</strong></td>
	<td width="350" align="center"><strong>Asiento</strong></td>
...
$result_cuenta = mysql_query("SELECT * FROM cwcondcohis WHERE Numcom='$Numcom' ORDER BY Numlim ASC", $conectar);
    ...
    {  	
		...
		echo '<table width="800" border="0" align="center">
			<tr align="center" border="0" >
				<td width="180" valign="top" align="left" class="texto8">'.$row["Cuenta"].'</td>
				<td width="30" valign="top" align="left" class="texto8">'.$row["Referen"].'</td>
				<td width="30" valign="top" align="left" class="texto8">'.$row["Tiporef"].'</td>
				<td width="350" valign="top" align="justify" class="texto8" colspan="2">'.$row["Descrip"].'</td>
