<?
	...
	if(isset($_POST['enviar']))
	{
		...
		$fecha_final = $fH[2]."-".$fH[1]."-".$fH[0];
			...
			location.href=\"reporte_analitico_historico.php?cuentadesde=".$_POST['cuenta_inicio']."&cuentahasta=".$_POST['cuenta_fin']."&fechadesde=".$fecha_inicio."&fechahasta=".$fecha_final."&saldoanterior=".$Salantu."\"</SCRIPT>";
		//}
		//}
