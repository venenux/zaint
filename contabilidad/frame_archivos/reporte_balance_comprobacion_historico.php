	...
	//echo $result;
   	...
   	{  	
		...
		else
		{
			...
			$consultahist="SELECT SUM(Credito) AS Credsum, SUM(Debito) AS Debsum  FROM cwcondcohis WHERE Cuenta LIKE '$Cuenta%' AND Fecha BETWEEN '2009-01-01' AND '$fechahastasalant'";
			$result_ant = mysql_query($consultahist, $conectar); 
		...
		$result_sum = mysql_query("SELECT SUM(Credito) AS Credsum, SUM(Debito) AS Debsum  FROM cwcondcohis WHERE Cuenta LIKE '$Cuenta%' AND Fecha BETWEEN '$fecha1' AND '$fecha2'", $conectar); 
